...
namespace Engine
{
   ...
   void Create( ) {
	  ...
	  Displacement.Data.m_ModifyEyePos = Memory::Scan(image_client, XorStr("E8 ? ? ? ? 8B 06 8B CE FF 90 ? ? ? ? 85 C0 74 4E")); // xref head_0
	  ...
	  Displacement.Function.m_LockStudioHdr = Memory::Scan(image_client, XorStr("E8 ?? ?? ?? ?? 8D 47 FC"));
