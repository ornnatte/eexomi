...
namespace Hooked
{
   bool CreateMoveHandler( float ft, CUserCmd* _cmd, bool* bSendPacket ) {
	  ...
	  if ( TickbaseShiftCtx.exploits_enabled && g_Vars.rage.hide_shots_bind.enabled && !g_Vars.rage.double_tap_bind.enabled ) {
	  ...
	  //|| ( TickbaseShiftCtx.exploits_enabled && g_Vars.rage.hide_shots_bind.enabled && !g_Vars.rage.double_tap_bind.enabled && !pLocal->CanShoot( ) ) 
